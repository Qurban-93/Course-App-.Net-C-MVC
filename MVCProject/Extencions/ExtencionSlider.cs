namespace MVCProject.Extencions
{
    public static class ExtencionSlider
    {
        ...
        public static string SaveImage(this IFormFile file, IWebHostEnvironment env, string root, string root2)
        {

            string fileName = string.Concat(Guid.NewGuid(), file.FileName);
            string fullPath = Path.Combine(env.WebRootPath, root, root2, fileName);
