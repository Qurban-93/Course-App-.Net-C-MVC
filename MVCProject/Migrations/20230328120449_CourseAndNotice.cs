...
{
    /// <inheritdoc />
    public partial class CourseAndNotice : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentsCount = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CoursePrice = table.Column<double>(type: "float", nullable: true),
